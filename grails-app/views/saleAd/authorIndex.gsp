...
<div id="list-saleAd" class="content scaffold-list" role="main">
    ...
    <table class="property-list saleAd">
        <thead>
        <tr>
            <th class="sortable"><a href="/saleAd/authorIndex/${saleAdList.get(0).author.username}?sort=title&amp;max=10&amp;order=asc">Titre</a></th>
            <th class="sortable"><a href="/saleAd/authorIndex/${saleAdList.get(0).author.username}?sort=price&amp;max=10&amp;order=asc">Prix</a></th>
